...
public class AddPersonnelController implements Initializable {
    ...
    @FXML
    private TextField StartCooperationDateField;

    @FXML
    private TextField CooperationTypeField;
    ...
    void ConfirmButtonAction() {
        try {
            Personels newPersonnel = new Personels(FirstNameField.getText(), LastNameField.getText(), MobileNumberField.getText(), "male", EmailField.getText(), BirthDateField.getText(), NationalCodeField.getText(), AddressField.getText(), StartCooperationDateField.getText(), Double.parseDouble(IncomeField.getText()), CommentField.getText(), CooperationTypeField.getText());
            if (FemaleRadioButton.isSelected()) {
                newPersonnel.setSex("female");
            }
            LoginController.user.addPersonel(newPersonnel, Start.database);
