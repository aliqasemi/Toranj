...
public class AddSaleController implements Initializable {
    ...
    @FXML
    private ComboBox<Customers> CustomerNameComboBox;

    @FXML
    private ComboBox<Productes> ProductNameComboBox;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        CustomerNameComboBox.setItems(LoginController.user.getCustomers(Start.database));
        ProductNameComboBox.setItems(LoginController.user.getProducts(Start.database));
        CustomerNameComboBox.setConverter(new StringConverter<Customers>() {
            @Override
        ...
        ProductNameComboBox.setConverter(new StringConverter<Productes>() {
            @Override
    ...
    void ConfirmButtonAction() {
        try {
            Sales newSale = new Sales(CustomerNameComboBox.getSelectionModel().getSelectedItem().getName(), CustomerNameComboBox.getSelectionModel().getSelectedItem().getLastName(), ProductNameComboBox.getSelectionModel().getSelectedItem().getName(), OrderDateField.getText(), DeliveryDateField.getText(), Integer.parseInt(ProductCountField.getText()), Double.parseDouble(DepositField.getText()), CommentField.getText());
            LoginController.user.add_sales(newSale, Start.database);
