...
public class AddSupplierController implements Initializable {
    ...
    void ConfirmButtonAction() {
        try {
            Suppliers newSupplier = new Suppliers(FirstNameField.getText(), LastNameField.getText(), MobileNumberField.getText(), "male", EmailField.getText(), FaxField.getText(), AddressField.getText(), NationalCodeField.getText(), CommentField.getText());
            if (FemaleRadioButton.isSelected()) {
                newSupplier.setSex("female");
            }
            LoginController.user.addSupplier(newSupplier, Start.database);
